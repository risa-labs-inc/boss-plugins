...
| [csv-review](csv-review/) | Local CSV/TSV quality review: bounded preview, explicit key checks, physical source-line findings, and JSON issues export without modifying input |
