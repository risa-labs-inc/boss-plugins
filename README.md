...
| [page-content](page-content/) | Structured page content (text, headings, links, screenshot) - the first plugin to expose a PageContentProvider for other plugins and agents |
